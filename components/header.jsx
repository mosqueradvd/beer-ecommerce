      ...
      <nav className="2xl:container 2xl:mx-auto sm:py-6 sm:px-7 py-5 px-4">
        ...
        <div className="flex justify-between ">
          <div className="hidden sm:flex flex-row items-center space-x-6">
            <p className="text-base cursor-pointer">New arrivals</p>
            <p className="text-base cursor-pointer">IPAS</p>
            <p className="text-base cursor-pointer">Lagers</p>
            <p className="text-base cursor-pointer">Regular</p>
            <p className="text-base cursor-pointer">Premier</p>
          </div>
